...
describe('CategoryService', () => {
  ...
  describe('createCategory', () => {
    it('writes exactly the whitelisted fields', async () => {
      ...
      await service.createCategory(sampleInput, actor);
      expect(repository.create).toHaveBeenCalledWith({ ...sampleInput, userId: actor.id });
    });
  });
  ...
  describe('updateCategory', () => {
    it('throws NotFoundError when the record does not exist', async () => {
      repository.findById.mockResolvedValue(null);
      await expect(service.updateCategory('missing-id', sampleInput, actor)).rejects.toThrow(NotFoundError);
    ...
    it('writes exactly the whitelisted fields when the record exists', async () => {
      ...
      await service.updateCategory('11111111-1111-4111-8111-111111111111', sampleInput, actor);
